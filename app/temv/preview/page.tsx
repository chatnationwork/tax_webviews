...
function TEMVPreviewContent() {
  ...
  return (
    <Layout
      title="TEMV — Preview"
      step="Step 3 of 3"
      onBack={() => router.push('/temv/traveler')}
      showMenu
    >
      <div className="space-y-4">
          ...
          <>
            ...
            <Card className="p-0">
              ...
              <div className="px-4 pb-1">
                ...
                <PreviewRow label="Date of Return" value={vd.date_of_entry} />
                <PreviewRow label="Period Abroad" value={vd.period_of_stay ? `${vd.period_of_stay} days` : undefined} />
                <PreviewRow label="Dest. Country" value={vd.destination_country} />
            ...
            <Card className="p-0">
              ...
              <div className="px-4 pb-1">
                ...
                <FileRow label="Owner Licence" value={td.owner_driving_license} />
        ...
        {!loading && !error && (
          <div className="flex gap-2 pt-2">
            <Button variant="secondary" onClick={() => router.push('/temv/traveler')} className="flex-1">
              Back
            </Button>
...
export default function TEMVPreviewPage() {
  return (
    <Suspense
      fallback={
