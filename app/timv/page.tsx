...
function TIMVHomeContent() {
  ...
  return (
    <Layout title="TIMV" showHeader={false}>
      <div className="space-y-6">
        ...
        <Card className="bg-white border-gray-200 p-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Apply for a TIMV certificate (Form C32) to bring a foreign-registered vehicle
              into Kenya temporarily without paying full import duty. You will need the vehicle
              logbook, insurance certificate, and owner ID documents.
            </p>
          </div>
        </Card>
        ...
        <div className="text-center pb-4">
          <p className="text-xs text-gray-400">Secure access to your TIMV certificate services.</p>
        </div>
      </div>
    </Layout>
  );
...
export default function TIMVPage() {
  return (
    <Suspense
      fallback={
