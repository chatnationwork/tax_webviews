...
function TIMVResultContent() {
  ...
  return (
    <Layout title="TIMV — Result" showHeader={false} showFooter={false}>
          ...
          <>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Reference: <span className="font-mono font-semibold text-gray-900">{cert?.ref_no ?? session.ref_no}</span>
              </p>
            </div>
...
export default function TIMVResultPage() {
  return (
    <Suspense
      fallback={
